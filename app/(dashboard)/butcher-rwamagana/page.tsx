...
import ButcherRwamaganaForm from '@/components/forms/ButcherRwamaganaForm';
...
// ─── Page ────────────────────────────────────────────────────────────────────
export default function ButcherRwamaganaDashboard() {
  ...
  const fetchRecords = useCallback(async () => {
    ...
    try {
      ...
      const res = await fetch('/api/butcher-rwamagana', {
...
// ─── Mobile Component ───────────────────────────────────────────────────────
function ButcherRwamaganaMobile() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      try {
        const fetchRes = await fetch('/api/butcher-rwamagana', {
          headers: { Authorization: `Bearer ${token}` }
        });
        if (fetchRes.ok) {
